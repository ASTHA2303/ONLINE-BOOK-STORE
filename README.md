...
Orders Table: Tracks transactional activity, including Order_ID, linked foreign keys (Customer_ID, Book_ID), transaction dates (Order_Date), purchased Quantity, and total revenue (Total_Amount).
